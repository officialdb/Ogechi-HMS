...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div class="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm relative overflow-hidden group print:border-slate-300">
            ...
            <p class="text-3xl font-black text-emerald-600 relative z-10">${{ number_format($totalRevenue, 2) }}</p>
        </div>
        ...
        <div class="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm relative overflow-hidden group print:border-slate-300">
            ...
            <p class="text-3xl font-black text-amber-600 relative z-10">${{ number_format($pendingRevenue, 2) }}</p>
        </div>
