    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(info) {
                // Prevent default url jumping so we can maybe do something custom, but here we just follow it normally
            },
            eventDidMount: function(info) {
                // Add a small tooltip or nice styling
        ...
        // Tailwind styling overrides for FullCalendar
        const style = document.createElement('style');
        style.innerHTML = `
            .fc-theme-standard td, .fc-theme-standard th { border-color: #f1f5f9; }
            .fc .fc-toolbar-title { font-size: 1.25rem; font-weight: 800; color: #0f172a; }
            .fc .fc-button-primary { background-color: #fff; color: #475569; border: 1px solid #e2e8f0; border-radius: 0.5rem; font-weight: 600; box-shadow: 0 1px 2px 0 rgb(0 0 0 / 0.05); text-transform: capitalize; }
            .fc .fc-button-primary:hover { background-color: #f8fafc; color: #0f172a; border-color: #cbd5e1; }
            .fc .fc-button-primary:disabled { background-color: #f8fafc; color: #94a3b8; border-color: #f1f5f9; }
            .fc .fc-button-active { background-color: #eff6ff !important; color: #2563eb !important; border-color: #bfdbfe !important; }
            .fc-col-header-cell-cushion { color: #64748b; font-weight: 700; font-size: 0.75rem; text-transform: uppercase; padding-top: 0.5rem !important; padding-bottom: 0.5rem !important; }
            .fc-daygrid-day-number { color: #475569; font-weight: 600; font-size: 0.875rem; padding: 0.5rem !important; }
            .fc-day-today { background-color: #f8fafc !important; }
            .fc-event { cursor: pointer; transition: transform 0.1s, opacity 0.1s; }
